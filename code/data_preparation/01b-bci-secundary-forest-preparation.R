...
for(i_patches in c("1patch", "25patches")){
  for(i_species in c("pft","genus")){
    for(i_period in c("period7", "period35")){
      ...
      secf_dt <- data.table(readxl::read_xls("raw-data/BCNM_secondary_forest_1ha_plots.xls", sheet = 1))

      #=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=
      # assign species ####
      #=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=
      species_codes <- fread(paste0(dir0, "/data-cleaning/",i_species,"/species_assigned.csv"))
      ...
      pdf(paste0(out_dir, "/pdat_secundary_forest.pdf"), width = 10, height = 5)
      p_list <- list(
      ...
      fwrite(stand_dt, paste0(out_dir,"/stand_dt_secf.csv"))
      ...
      for(i_age in c(40)){
        ...
        ### initial_cohorts.csv ####
        fwrite(initial_trees, paste0(out_dir,"/initial_cohorts_100patches_0.1ha_age",i_age,".csv"))
        fwrite(initial_trees[repID == 1], paste0(out_dir,"/initial_cohorts_10patches_0.1ha_age",i_age,".csv"))
      }
