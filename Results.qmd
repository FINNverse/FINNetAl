...
ggplot(p_cors2[grepl("pft", scale) & simreal == "simulated"],aes(x = variable, y = forcats::fct_reorder(response, -nresponses), fill = r)) +
  ...
  labs(x = "Predicted Variable", y = "Loss Variables", fill = "Spearmans R") +
  theme_classic() +
...
p_proc_comp <- ggplot(
  ...
  facet_wrap(process~paste0("PFT = ", species), ncol = 5, scales = "fixed") +
  theme_classic()+
...
p_env <- ggplot(
  ...
  geom_hline(yintercept = 0)+
  facet_wrap(process~paste0("PFT = ", species), ncol = 5, scales = "free_x") +
  labs(x = "Parameter", y = "Difference")+
  theme_classic()+
