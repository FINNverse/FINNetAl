...
### Figure 4b - Succession trajectories
...
rmse_dt_all2 <- rmse_dt_all[,.(
  rmse = round(mean(sqrt((value.sim-value.obs)^2)),3)
), by = .(species2, variable2, type)]

dcast(rmse_dt_all2, variable2~type, value.var = "rmse", fun.aggregate = sum)
