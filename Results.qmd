...
fitted_models <- c(
    ...
    list.files("results/02_realdata_hybridTF0_26-04-16_0.4/", full.names = T, recursive = T, pattern = chosen_scale)
...
### Figure S5 - Simulation vs. Observation
```{r}
#| label: figure_S5
#| fig-format: pdf
#| fig-width: 13
