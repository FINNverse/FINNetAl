...
grid.arrange(
  grobs = c(
    ...
    list(p_list[[2]]
      ...
      +geom_hline(data = avg_obs_dt2_min,aes(yintercept = value, color = species2), linetype = "dashed", linewidth = 0.5)+theme(legend.position = "none"), 
         p_list[[1]]
      +geom_hline(data = avg_obs_dt2,aes(yintercept = value, color = species2), linetype = "solid", linewidth = 0.5)
      +geom_hline(data = avg_obs_dt2_max,aes(yintercept = value, color = species2), linetype = "dashed", linewidth = 0.5)
      +geom_hline(data = avg_obs_dt2_min,aes(yintercept = value, color = species2), linetype = "dashed", linewidth = 0.5)+theme(legend.position = "none")), list(legend_p)),
  ncol = 2,
  layout_matrix = rbind(c(1, 2), c(3, 4), c(5,5)),
  heights = c(0.05, 0.90,0.2)
)
