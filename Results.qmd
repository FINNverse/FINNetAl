...
vars <- c("ba", "trees", "dbh", "reg", "growth", "mort")
var_labels2 <- c(
  "Basal Area [m²/ha]", "Trees [N/ha]", "avg. DBH [cm]",
  "Regeneration [N/ha]", "Growth [%/100]", "Mortality [%/100]"
)
...
#| message: false
#| warning: false
#| fig-cap: "Estimated environmental-response coefficients of Process-FINN (blue) and Hybrid-FINN (red) calibrated on the BCI forest inventory data, shown for the growth and mortality processes and for each of the five plant functional types. Each environmental-response function maps the intercept and six climatic covariates (Prec, SR_kW_m2, RH_prc, T_max, T_min, swp) to a scaled effect on the corresponding demographic rate; the coefficients are therefore distinct from, and complementary to, the mechanistic process parameters shown in Figure A4. Because Hybrid-FINN replaces the growth process with a DNN, it has no growth environmental-response coefficients; the growth panels therefore show estimates for Process-FINN only."
